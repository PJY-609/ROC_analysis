...
def analyzeParameters(interval, content, patient_list):
    '''analyze the CTP parameters and return the resulting fprs and tprs after
    pix-to-pix comparison
    
    Args:
        interval: the setting range of a certain parameter
        content: the name of CTP parameters
        patient_list: list of the patients' ID
...
def plotROCCurve(content, patient_list):
    '''the main fucntion to plot ROC curve
